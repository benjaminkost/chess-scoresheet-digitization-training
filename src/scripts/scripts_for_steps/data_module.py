...
from .preprocessing_strategy import PreprocessingStrategy, EncodingStrategy
...
class DataModuleTransformer(DataModule, EncodingStrategy):
    @abstractmethod
    def get_encoding(self, encoding: EncodingStrategy):
        pass
...
# Implement a concrete class for Image Data Ingestion
class HuggingFaceImageDataModuleForTransformer(DataModuleTransformer):
